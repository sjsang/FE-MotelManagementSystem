...
export default function ReportPage() {
    ...
    const handleExportExcel = async () => {
        try {
            ...
            link.href = url;
            link.setAttribute('download', `DoanhThu_${dateRange.from}_${dateRange.to}.xlsx`);
    ...
    const handleExportBCA = async (bcaParams) => {
        try {
            ...
            link.setAttribute('download', `BaoCao_TT30_BCA_${bcaParams.from}_${bcaParams.to}.xlsx`);
            document.body.appendChild(link);
            link.click();
            link.remove();
    ...
    return (
        <div className="revenue-page-container">
            ...
            <div className="page-header" style={{ marginBottom: 20 }}>
                ...
                <div className="page-subtitle" style={{ color: '#666' }}>
