      ...
      >
        ...
        >
          {[
            ...
            >
              <span style={{ fontSize: 13.5, color: "#6b6f84" }}>{label}</span>
        ...
        {previewLoading && !preview ? (
          ...
          <>
            ...
            {[
              ...
              >
                <span style={{ fontSize: 16, color: "#424f42" }}>{label}</span>
        ...
        >
          ...
          <span style={{ fontSize: 17, fontWeight: 700, color: "#10b981" }}>
        ...
        {(deposit > 0 || safeDeposit >= 0) && (
          <>
            ...
            >
              <span style={{ fontSize: 16, color: "#424f42" }}>Tạm ứng</span>
              <input
                type="text"
                className="form-control"
                value={
                  safeDeposit === 0 ? "" : safeDeposit.toLocaleString("vi-VN")
                }
                onChange={(e) => {
                  const raw = e.target.value.replace(/\D/g, "");
                  setDepositOverride(raw ? Number(raw) : 0);
                }}
                placeholder="0"
                style={{
                  width: 110,
            ...
            >
              <span style={{ fontSize: 16, fontWeight: 700 }}>Thực thu</span>
